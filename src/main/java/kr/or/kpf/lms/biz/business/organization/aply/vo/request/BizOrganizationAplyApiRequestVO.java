...
public class BizOrganizationAplyApiRequestVO {
    ...
    @NotEmpty(groups={CreateBizOrganizationAply.class, UpdateBizOrganizationAply.class}, message="사업 공고 일련번호은 필수 입니다.")
    ...
    @NotNull(groups={CreateBizOrganizationAply.class, UpdateBizOrganizationAply.class}, message="사업 공고 신청 접수 상태는 필수 입니다.")
    ...
    @Schema(description="사업 공고 년도", required = false, example="1")
    private Integer years;

    @Schema(description="수업계획서 리스트", required = false, example="1")
    private List<BizOrganizationAplyDtlApiRequestVO> bizOrganizationAplyDtlApiRequestVOS;
