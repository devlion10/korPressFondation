...
import kr.or.kpf.lms.biz.communication.archive.guide.vo.CreateArchiveClassGuide;
import kr.or.kpf.lms.biz.communication.archive.guide.vo.UpdateArchiveClassGuide;
...
public class ArchiveClassGuideApiRequestVO {
    ...
    @Schema(description="수업 지도안 타입 ( 1: 교사, 2: 학부모, 3: 기타(다문화/유아/일반) )", required=true, example="")
    ...
    /** E-NIE 여부 */
    @Schema(description="E-NIE 여부", required=false, example="")
    ...
    @Schema(description="수업지도안 신청 상태(0: 임시저장, 1: 신청(접수))", required=true, example="")
    ...
    @Schema(description="수업지도안 승인 상태(0: 미승인, 1: 승인)", required=true, example="")
