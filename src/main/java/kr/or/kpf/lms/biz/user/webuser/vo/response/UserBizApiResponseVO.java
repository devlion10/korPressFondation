...
@NoArgsConstructor
@AllArgsConstructor
public class UserBizApiResponseVO extends CSResponseVOSupport {
    ...
    @Schema(description="사용자 상태 코드 (1: 정상, 2: 휴면, 3: 잠금, 4: 탈퇴)")
    ...
    private OrganizationAuthorityHistory organizationInfo;
}
